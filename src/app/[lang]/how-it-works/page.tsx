                ...
                <div className="space-y-20 relative before:absolute before:inset-0 before:ml-8 md:before:ml-0 md:before:left-1/2 before:-translate-x-px before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-border before:to-transparent before:z-0">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:justify-between group">
                        <div className="order-2 md:order-1 md:w-5/12 text-left md:text-right">
                            <h2 className="text-2xl font-bold mb-3 group-hover:text-primary transition-colors">1. {dict.home.heroTitle}</h2>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:justify-between group">
                        ...
                        <div className="order-2 md:order-3 md:w-5/12 text-left">
                            <h2 className="text-2xl font-bold mb-3 group-hover:text-accent transition-colors">2. {dict.features.title1}</h2>
                            <p className="text-muted-foreground leading-relaxed">
                                {dict.features.desc1}
                            </p>
                        </div>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:justify-between group">
                        <div className="order-2 md:order-1 md:w-5/12 text-left md:text-right">
                            <h2 className="text-2xl font-bold mb-3 group-hover:text-green-500 transition-colors">3. {dict.features.title2}</h2>
                            <p className="text-muted-foreground leading-relaxed">
                                {dict.features.desc2}
                            </p>
                        </div>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center md:justify-between group">
                        ...
                        <div className="order-2 md:order-3 md:w-5/12 text-left">
                            <h2 className="text-2xl font-bold mb-3 group-hover:text-primary transition-colors">4. {dict.features.title3}</h2>
                            <p className="text-muted-foreground leading-relaxed">
                                {dict.features.desc3}
                            </p>
                        </div>
