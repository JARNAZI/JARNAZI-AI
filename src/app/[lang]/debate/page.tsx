...
import { LayoutTemplate, Menu, History, Zap, ChevronRight, MessageSquare, CreditCard, User, Phone, Sun, Moon, Globe, LogOut } from 'lucide-react';
import NotificationBell from '@/components/notifications/NotificationBell';

export default function DebateDashboard(props: { params: Promise<{ lang: string }> }) {
    const params = use(props.params);
    type DebateRecord = { id: string; topic?: string | null; created_at?: string | null; updated_at?: string | null; status?: string | null; final_answer?: string | null; };
