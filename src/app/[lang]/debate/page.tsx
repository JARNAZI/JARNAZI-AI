                ...
                <div className="fixed inset-0 z-[100] flex justify-end">
                    ...
                    <div className="relative w-80 h-full bg-[#0a0a0a] border-l border-white/10 shadow-2xl p-6 flex flex-col animate-in slide-in-from-right duration-200">
                        ...
                        <nav className="flex-1 space-y-2">
                            ...
                            <Link href={`/${params.lang}/plans`} className="flex items-center gap-4 p-3 rounded-xl hover:bg-zinc-900 text-zinc-300 transition-colors">
                                <CreditCard className="w-5 h-5 text-indigo-500" />
                                <span className="font-bold uppercase tracking-wider text-xs">Plans / Billing</span>
                            </Link>
